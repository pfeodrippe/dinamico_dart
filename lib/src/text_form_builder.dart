...
/// Modified version of https://github.com/peiffer-innovations/json_dynamic_widget/blob/main/lib/src/builders/json_text_form_field_builder.dart
/// which allows pass the `value` field. otherwise is the same.
/// Builder that can build an [TextFormField] widget.  See the [fromDynamic] for
/// the format.
class TextFormFieldBuilder extends JsonWidgetBuilder {
  ...
  ///  * [Validator]
  static TextFormFieldBuilder? fromDynamic(
    dynamic map, {
    JsonWidgetRegistry? registry,
  }) {
    TextFormFieldBuilder? result;
    if (map != null) {
      var controller = TextEditingController(text: map['initialValue']);
      if (map['value'] != null) {
...
class _JsonTextFormFieldWidget extends StatefulWidget {
  ...
  final TextFormFieldBuilder builder;
      ...
      if (event == widget.data.id) {
        ...
        var textValue = widget.builder.controller.value.copyWith(
            ...
            selection: TextSelection(
                baseOffset: widget.builder.controller.selection.end,
                extentOffset: widget.builder.controller.selection.end),
